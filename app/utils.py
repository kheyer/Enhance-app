                    ...
                    <div class="container-contact100">
                        <div class="wrap-contact100">
                            ...
                            <div>
                                ...
                                <img src="data:image/png;base64,{img_io}" class="image-display">
                            ...
                            <div class="container-contact100-form-btn">
                                <div class="wrap-contact100-form-btn">
                                    ...
                                    <button type = "button" id = "submit_btn" class="contact100-form-btn">
                                        ...
                                        <a download="enhanced_image.png" href="data:image/png;base64,{img_io}" class="contact100-form-btn" target="_blank">
                                            Download
                                        </a>
                                    </button>
                                </div>
